# segmentio/parquet-go [![build status](https://github.com/alxarno/parquet-go-athena-list-hack/actions/workflows/test.yml/badge.svg?branch=main)](https://github.com/alxarno/parquet-go-athena-list-hack/actions) [![Go Report Card](https://goreportcard.com/badge/github.com/alxarno/parquet-go-athena-list-hack)](https://goreportcard.com/report/github.com/alxarno/parquet-go-athena-list-hack) [![Go Reference](https://pkg.go.dev/badge/github.com/alxarno/parquet-go-athena-list-hack.svg)](https://pkg.go.dev/github.com/alxarno/parquet-go-athena-list-hack)
...
```
go get github.com/alxarno/parquet-go-athena-list-hack
```
...
### Writing Parquet Files: [parquet.GenericWriter[T]](https://pkg.go.dev/github.com/alxarno/parquet-go-athena-list-hack#GenericWriter)
...
### Reading Parquet Files: [parquet.GenericReader[T]](https://pkg.go.dev/github.com/alxarno/parquet-go-athena-list-hack#GenericReader)
...
### Inspecting Parquet Files: [parquet.File](https://pkg.go.dev/github.com/alxarno/parquet-go-athena-list-hack#File)
...
### Evolving Parquet Schemas: [parquet.Convert](https://pkg.go.dev/github.com/alxarno/parquet-go-athena-list-hack#Convert)
...
### Sorting Row Groups: [parquet.GenericBuffer[T]](https://pkg.go.dev/github.com/alxarno/parquet-go-athena-list-hack#Buffer)
...
### Merging Row Groups: [parquet.MergeRowGroups](https://pkg.go.dev/github.com/alxarno/parquet-go-athena-list-hack#MergeRowGroups)
...
### Using Bloom Filters: [parquet.BloomFilter](https://pkg.go.dev/github.com/alxarno/parquet-go-athena-list-hack#BloomFilter)
...
See [parquet.RowGroup](https://pkg.go.dev/github.com/alxarno/parquet-go-athena-list-hack#RowGroup)
...
See [parquet.PageBufferPool](https://pkg.go.dev/github.com/alxarno/parquet-go-athena-list-hack#PageBufferPool)
for the full interface documentation.
...
The project uses [Github Actions](https://github.com/alxarno/parquet-go-athena-list-hack/actions) for CI.
